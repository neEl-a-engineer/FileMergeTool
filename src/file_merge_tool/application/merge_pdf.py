...
def merge_pdf(request: MergeRequest) -> MergeResult:
    ...
    for item in scanned_items:
        ...
        matched_markers = _matched_markers(
            [item.absolute_path.name, extracted.first_page_text],
            markers,
    ...
    *,
    ...
    payload = {
        ...
        "summary": ArtifactSummary(
            ...
            rescued_count=sum(1 for item in serializable_items if (item.get("merge_recovery") or {}).get("fidelity") not in (None, "exact")),
