...
def merge_pdf(request: MergeRequest) -> MergeResult:
    ...
    normal_path = request.output_dir / f"{output_stem}.pdf"
    sensitive_path = request.output_dir / f"{output_stem}{SENSITIVE_SUFFIX}.pdf"
...
def _header_lines(
    ...
    return [
        ...
        "Schema: file-merge-tool/pdf-merge/v1",
